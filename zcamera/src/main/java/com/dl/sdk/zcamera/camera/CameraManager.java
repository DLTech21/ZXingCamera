    ...
    public Camera.Parameters getCameraParams() {
        if (camera != null) {
            if (camera.getCamera() != null) {
                Camera.Parameters mParams = camera.getCamera().getParameters();
                return mParams;
            }
        }
        return null;
...
//      int topOffset = (screenResolution.y - height) / 2;
            int topOffset = (int) (screenResolution.y * 0.18);
...
//    }
//
//    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data, int width, int height, int left, int top, int cwidth) {
